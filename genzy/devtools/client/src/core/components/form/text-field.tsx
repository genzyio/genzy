    ...
    <div>
      ...
      <div className="mt-1">
        <input
          ...
          {...props}
          className={`block w-full rounded-md border-0 py-1.5 bg-brand-node-dark shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset ${
            error ? "focus:ring-red-600" : "focus:ring-gray-600"
