...
import { type ProjectDefinitionData } from "../project-definition/project-definition.models";
...
async function startProject(project: Project, projectData: ProjectDefinitionData) {
